...
-export([enc_nfsstat3/1, dec_nfsstat3/2]).
-export([enc_ftype3/1, dec_ftype3/2]).
...
-export([enc_time_how/1, dec_time_how/2]).
...
-export([enc_stable_how/1, dec_stable_how/2]).
...
-export([enc_createmode3/1, dec_createmode3/2]).
